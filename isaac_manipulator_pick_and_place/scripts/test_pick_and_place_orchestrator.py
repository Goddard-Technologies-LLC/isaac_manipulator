...
# TODO verify these last two imports are needed
...
class PickAndPlaceOrchestrator(Node):
    ...
    def __init__(self):
        ...
        #TODO change gripper action name (could be via launch)?
        # it'll also be changed to a regular topic so that can be updated as well.
        ...
        # TODO verify if it's staying a cube
        ...
        # TODO update/remove the mesh uri to be the new one
        ...
        # TODO verify this action client connection. This is probably the thing we'll use for call getting the pose?
        ...
        # TODO !!!!!!!!!!!!!GRIPPER ALERT GRIPPER ALERT!!!!!!!!!!!!!!!!
        self._gripper_cb_group = MutuallyExclusiveCallbackGroup()
        self._gripper_client = self.create_client(SetIO, "/io_and_status_controller/set_io", callback_group=self._gripper_cb_group)
        self._gripper_done_event = Event()
        self._gripper_done_result = False

        # TODO figure out what this is
        # looks like it reads predetermined grasp poses relative to the target from some yaml file
        ...
        # TODO modify gripper frame name to be generic
...
# TODO verify usage. But otherwise seems fine.....
    ...
    # TODO needs to have poses reworked and updated
    ...
    # TODO determine what goal handel is and what the purpose here is. Seems to be foundation/detr related......
    ...
    # TODO rewrite for our purposes
    def trigger_gripper(self, open_gripper: bool):
        """Trigger gripper to either open (true/1) or close (false/0)
        ...
        gripper_goal = SetIO.Request()
        gripper_goal.fun = SetIO.FUN_SET_DIGITAL_OUT
        gripper_goal.pin = 17
        if open_gripper:
            gripper_goal.state = 1.0
        else:
            gripper_goal.state = 0.0
...
# TODO open gripper update
    ...
    def execute_callback(self, goal_handle) -> PickAndPlace.Result:
        ...
        #TODO replace with own get_pose action server
        ...
        # TODO replace with custom gripper action server
        ...
        # TODO replace with custom trigger
        ...
        # TODO verify with new gripper controller
