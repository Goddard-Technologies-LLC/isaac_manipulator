...
def launch_setup(context, *args, **kwargs):
    ...
    # TODO not sure what they use this for.... maybe gripper controls? Or jsut for the RTDE connection?
    ...
    if gripper_type.perform(context) == 'robotiq_2f_140':
        ...
        grasp_parent_frame = "schmalz_base_link"
    else:
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution([FindPackageShare('isaac_manipulator_pick_and_place'),
                                 'urdf', 'ur_schmalz_gripper.urdf.xacro']),
            ' ',
            'robot_ip:=',
            robot_ip,
            ' ',
    ...
    #TODO add custom controller launcher

    # This is good?
    initial_joint_controllers = PathJoinSubstitution(
        [FindPackageShare('isaac_manipulator_pick_and_place'), 'config', 'goddard_controllers.yaml']
    )
    ...
    Looks like the end of setup and the begining of the actual launch construction - PJG
    ...
    # TODO Replace with own detection service
    ...
    grasp_config_file = (
        ...
        '/config/' + gripper_type.perform(context) + '_generic.yaml'
    )
